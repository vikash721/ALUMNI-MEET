...
import styles from './AlumniLogin.module.css';
import Notification from '../../notification/Notificationmodal'; 
import AlumniSignup from '../alumni_signup/AlumniSignup';

const AlumniLogin = ({ closeModal }) => {
    ...
    return (
        <>
            ...
            {showSignup ? (
                <AlumniSignup closeModal={closeModal} />
            ) : (
