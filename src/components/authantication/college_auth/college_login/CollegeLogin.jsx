...
import Notification from '../../notification/Notificationmodal'; 
import CollegeSignup from '../college_signup/CollegeSignup';

const CollegeLogin = ({ closeModal }) => {
    ...
    return (
        <>
            ...
            {showSignup ? (
                <CollegeSignup closeModal={closeModal} />
            ) : (
                <div className={styles.customModalOverlay}>
                    <div className={styles.customModal}>
                        <div className={styles.customModalHeader}>
                            
                            <header className={styles.header} >College Login </header>
